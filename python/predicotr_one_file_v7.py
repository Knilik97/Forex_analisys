...
MODEL_FILE = "python/model_v7.h5"
SCALER_FEATURES_FILE = "python/scaler_features_v7.pkl"
SCALER_PRICE_FILE = "python/scaler_price_v7.pkl"
...
def main():
    ...
    print(f"🔮 Прогноз цены через 3 свечи (60 минут): {predicted_price_real:.5f}")
