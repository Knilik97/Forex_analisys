...
BATCH_SIZE = 64
MODEL_NAME = "model_v7_USDCHF.h5" # Новое имя для новой модели
# ------------------
...
def main():
    ...
    INPUT_FILE = "/content/ready_for_training_USDCHF_H1.csv"
    ...
    import json
    with open('history_v7_USDCHF.json', 'w') as f:
        json.dump(history.history, f)

    # 3. Сохранение масштабировщиков и модели (гарантированно)
    joblib.dump(scaler_y, 'scaler_price_v7_USDCHF.pkl')
    joblib.dump(scaler_X, 'scaler_features_v7_USDCHF.pkl')
