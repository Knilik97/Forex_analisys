...
MODEL_FILE = "python/train_model_v7_USDCHF/model_v7_USDCHF.h5"
SCALER_FEATURES_FILE = "python/train_model_v7_USDCHF/scaler_features_v7_USDCHF.pkl"
SCALER_PRICE_FILE = "python/train_model_v7_USDCHF/scaler_price_v7_USDCHF.pkl"
LOG_FILE = "prediction_log_USDCFH.txt" # <-- НОВОЕ: Имя файла для лога
# ------------------
