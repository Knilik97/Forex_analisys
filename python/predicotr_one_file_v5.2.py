...
# --- НАСТРОЙКИ ---
SYMBOL = "EURUSD"
TIMEFRAME = mt5.TIMEFRAME_M15 # Таймфрейм должен совпадать с обучением (V6)
SEQ_LEN = 96                 # Длина последовательности (из обучения)
NUM_CANDLES_TO_DOWNLOAD = 300 # Скачиваем с запасом
MODEL_FILE = "python/model_v5.1.h5"
SCALER_FEATURES_FILE = "python/scaler_features_v5.1.pkl"
SCALER_PRICE_FILE = "python/scaler_price_v5.1.pkl"
LOG_FILE = "prediction_log.txt" # <-- НОВОЕ: Имя файла для лога
# ------------------
...
def main():
    ...
    print(f"🔮 Прогноз цены через 3 свечи (15 минут): {predicted_price_real:.5f}")
