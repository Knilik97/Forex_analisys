...
# --- НАСТРОЙКИ ---
SEQ_LEN = 96            # Сколько прошлых свечей модель будет "помнить"
FUTURE_PERIOD_PREDICT = 3 # <-- ИЗМЕНЕНИЕ: Предсказываем через n свечей
BATCH_SIZE = 64
MODEL_NAME = "model_v6.2.h5" # Новое имя для новой модели
# ------------------
...
def main():
    print("🚀 Загрузка данных для V6.2...")
    
    INPUT_FILE = "data/ready_for_training_30m.csv"
    ...
    print("🧠 Начало обучения модели V5...")
    ...
    joblib.dump(scaler_y, 'scaler_price_v6.2.pkl') 
    joblib.dump(scaler_X, 'scaler_features_v6.2.pkl')
    
    print(f"💾 Финальные файлы сохранены:")
    print(f"- Модель: {MODEL_NAME}")
    print(f"- Масштабер цены: scaler_price_v6.2.pkl")
