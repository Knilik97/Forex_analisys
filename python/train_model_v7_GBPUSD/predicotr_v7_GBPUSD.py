...
MODEL_FILE = "python/train_model_v7_GBPUSD/model_v7_GBPUSD.h5"
SCALER_FEATURES_FILE = "python/train_model_v7_GBPUSD/scaler_features_v7_GBPUSD.pkl"
SCALER_PRICE_FILE = "python/train_model_v7_GBPUSD/scaler_price_v7_GBPUSD.pkl"
LOG_FILE = "prediction_log_GBPUSD.txt" # <-- НОВОЕ: Имя файла для лога
# ------------------
