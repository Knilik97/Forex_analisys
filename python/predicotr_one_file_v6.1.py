...
# --- НАСТРОЙКИ ---
SYMBOL = "EURUSD"
TIMEFRAME = mt5.TIMEFRAME_M30 # Таймфрейм должен совпадать с обучением (V6)
SEQ_LEN = 96                 # Длина последовательности (из обучения)
NUM_CANDLES_TO_DOWNLOAD = 300 # Скачиваем с запасом
MODEL_FILE = "python/model_v6.1.h5"
SCALER_FEATURES_FILE = "python/scaler_features_v6.1.pkl"
SCALER_PRICE_FILE = "python/scaler_price_v6.1.pkl"
...
def main():
    ...
    print(f"🔮 Прогноз цены через 3 свечи (30 минут): {predicted_price_real:.5f}")
