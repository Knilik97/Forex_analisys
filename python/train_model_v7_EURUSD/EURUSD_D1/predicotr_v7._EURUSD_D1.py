...
# --- НАСТРОЙКИ ---
SYMBOL = "EURUSD"
TIMEFRAME = mt5.TIMEFRAME_D1 # Таймфрейм должен совпадать с обучением (V7)
SEQ_LEN = 100                 # Длина последовательности (из обучения)
NUM_CANDLES_TO_DOWNLOAD = 300 # Скачиваем с запасом
MODEL_FILE = "python/train_model_v7_EURUSD/EURUSD_D1/model_v7_EURUSD_1D.h5"
SCALER_FEATURES_FILE = "python/train_model_v7_EURUSD/EURUSD_D1/scaler_features_v7_D1_EURUSD.pkl"
SCALER_PRICE_FILE = "python/train_model_v7_EURUSD/EURUSD_D1/scaler_price_v7_D1_EURUSD.pkl"
LOG_FILE = "hystory_log/prediction_log_D1_EURUSD.txt"
# ------------------
