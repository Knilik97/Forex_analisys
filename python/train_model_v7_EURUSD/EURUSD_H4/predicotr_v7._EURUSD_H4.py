...
SEQ_LEN = 48                 # Длина последовательности (из обучения)
NUM_CANDLES_TO_DOWNLOAD = 300 # Скачиваем с запасом
MODEL_FILE = "python/train_model_v7_EURUSD/EURUSD_H4/model_v7_EURUSD_4H.h5"
SCALER_FEATURES_FILE = "python/train_model_v7_EURUSD/EURUSD_H4/scaler_features_v7_H4_EURUSD.pkl"
SCALER_PRICE_FILE = "python/train_model_v7_EURUSD/EURUSD_H4/scaler_price_v7_H4_EURUSD_.pkl"
