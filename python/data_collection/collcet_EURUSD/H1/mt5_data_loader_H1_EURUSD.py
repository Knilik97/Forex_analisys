...
TIMEFRAME = mt5.TIMEFRAME_H1 # _М... данный таймфрейм 
OUTPUT_FOLDER = 'data/EUR_USD/H1' # Папка для сохранения
...
output_path = os.path.join(OUTPUT_FOLDER, f'{SYMBOL}_H1.csv') # Здесь меняем название в окочании H1, M15, M30 и и т.п
