...
# --- НАСТРОЙКИ ---
INPUT_FILE = "data\EUR_USD\M30\EURUSD_M30.csv"
OUTPUT_FILE = "data/EUR_USD/M30/EURUSD_M30_with_features.csv"
# ------------------
...
try:
    ...
    print("Сначала нужно запустить mt5_data_loader_m30)EURUSD.py")
    quit()
