...
OUTPUT_FOLDER = 'data/EUR_USD/D1' # Папка для сохранения
...
output_path = os.path.join(OUTPUT_FOLDER, f'{SYMBOL}_D1.csv') # Здесь меняем название в окочании H1, M15, M30 и и т.п
